...
**Inputs:** A contained case directory with the customer brief, historical CSV, prospect CSV, and canonical Leadbay state.

**Outputs:** Runtime-validated `CustomerBrief`, `LeadbayState`, resolved paths, and loaded case metadata.
...
**Outputs:** Transparent policy scores, coverage, top-bucket lift, false-positive and false-negative examples, unknowns, and ranked prospects.
