...
CI runs the repository against the real `@leadbay/mcp@0.40.0` process in mock mode. The committed package keeps volatile trace timings normalized so reviewers can diff it cleanly.
