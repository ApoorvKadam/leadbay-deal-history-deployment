...
import { assertSyntheticQualityGates, loadExpectedPolicy } from "../helpers/expected-policy.js";

const expected = loadExpectedPolicy();
...
describe("synthetic expected policy contract", () => {
  it("passes every semantic policy and quality expectation", () => {
    ...
    expect(expected.case_id).toBe(loaded.brief.case_id);
    expect(() =>
