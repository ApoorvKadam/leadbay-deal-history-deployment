...
describe("reviewer documentation", () => {
  ...
  it("documents the customer problem, safety contract, operation, and verified repository state", () => {
    ...
    expect(readme).toMatch(/fixture generator deliberately plants/i);
    expect(readme).toMatch(/does not validate Leadbay.*public-text answers/i);
    expect(readme).toMatch(/real deployment.*qualify.*historical companies.*Leadbay/i);
    ...
    expect(readme).toContain("35 test files and 135 passing tests");
