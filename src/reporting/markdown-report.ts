...
The following fields were excluded from policy evidence: ${input.brief.prohibited_columns.join(", ")}. Company identity groups were kept wholly within one temporal partition to avoid repeated-company leakage.
